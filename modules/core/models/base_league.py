...
class BaseLeagueMixin:
    ...
    def to_dict(self):
        ...
        return {
            ...
            'games_url': getattr(self, 'games_url', None),
            'table_url': getattr(self, 'table_url', None),
            'scorers_url': getattr(self, 'scorers_url', None),
            'assists_url': getattr(self, 'assists_url', None),
            'canadian_url': getattr(self, 'canadian_url', None),
