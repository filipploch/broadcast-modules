...
def replay_sequence(context):
    ...
    return [
        ...
        show_source(delay_ms=1700),                                         # t=700
        show_transition(delay_ms=1700 + _replay_duration),                  # t=700+duration
        show_source(is_visible=False, delay_ms=1700 + _replay_duration + 800)  # t=700+duration+700
    ]
