// WebSocket z rejestracją jako overlay + subskrypcja timer
    ...
    function updateScoreboard(data) {
        ...
        const penaltyRow = document.getElementById('penalty-score-row');
        if (penaltyRow) {
            if (data.shootout) {
                document.getElementById('penalty-home').textContent = data.shootout.home_team_shootouts;
                document.getElementById('penalty-away').textContent = data.shootout.away_team_shootouts;
